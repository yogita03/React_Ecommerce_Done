...
//   const handleShow = () => setShow(true);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
     ...
     let URL = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCQ0iHKpkDAqT6SkGiaidr7HpPpD_Ugekk" ;
     if(isSignIn){
        URL = "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCQ0iHKpkDAqT6SkGiaidr7HpPpD_Ugekk"
     }
